...
description: Use this skill whenever the user asks to design, code, or prototype a UI that feels like Notion. This includes landing pages, dashboards, card layouts, and internal tools. Even if the user just asks for "minimalist" or "clean" design, use this skill to apply the specific warm-neutral aesthetic and "whisper-weight" border philosophy of Notion.
---
